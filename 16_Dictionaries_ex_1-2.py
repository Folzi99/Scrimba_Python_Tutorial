...
for shop in (freelancers, antiques, pet_shop):
    #inputbox  to show what you can buy...capture textstring of what was bought...make lowercase
    buy_item = input(f'Welcome to {shop["name"]}! what do you want to buy: {shop} ').lower() # Convert to lower case to remove case sensitivity
    #update the cart
    cart.update({buy_item:shop.pop(buy_item)}) # .pop removes item from shop list
    #print(shop)
    #print(cart)
    bought_item = ", ".join(list(cart.keys()))
print(f'You Purchased: {bought_item}. Today it is all free. Have a nice day of mayhem! ')


#### CONTINUE WATCHING FROM: DICTIONARIES EXERCISE V1.2, 1.5
# Version 2
